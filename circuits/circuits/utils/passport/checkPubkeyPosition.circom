...
template CheckPubkeyPosition(prefixLength, maxPubkeyLength, suffixLength, signatureAlgorithm) {
    ...
    var validPrefixes[NUM_VALID_PREFIXES][prefixLength] = getValidRSAPrefixes();
    ...
    var keyLengths[NUM_VALID_PREFIXES] = prefixIndexToRSAKeyLength();
    ...
    signal key_length_ok <== IsEqual()([
        key_length_sums[NUM_VALID_PREFIXES] / 8,
        pubkey_actual_length
    ]);
    key_length_ok === 1;
    
    // check the suffix is the modulus of the circuit
