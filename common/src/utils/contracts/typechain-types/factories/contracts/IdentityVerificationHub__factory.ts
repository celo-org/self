...
import type {
  ...
  IdentityVerificationHubInterface,
} from "../../contracts/IdentityVerificationHub";
...
type IdentityVerificationHubConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: IdentityVerificationHubConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class IdentityVerificationHub__factory extends ContractFactory {
  constructor(...args: IdentityVerificationHubConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  ): IdentityVerificationHub__factory {
    return super.connect(runner) as IdentityVerificationHub__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): IdentityVerificationHubInterface {
    return new Interface(_abi) as IdentityVerificationHubInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IdentityVerificationHub;
  }
}
