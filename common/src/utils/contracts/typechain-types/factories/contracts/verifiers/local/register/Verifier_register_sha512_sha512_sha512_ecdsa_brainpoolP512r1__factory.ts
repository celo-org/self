...
import type {
  ...
  Verifier_register_sha512_sha512_sha512_ecdsa_brainpoolP512r1Interface,
} from "../../../../../contracts/verifiers/local/register/Verifier_register_sha512_sha512_sha512_ecdsa_brainpoolP512r1";
...
type Verifier_register_sha512_sha512_sha512_ecdsa_brainpoolP512r1ConstructorParams =
  [signer?: Signer] | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: Verifier_register_sha512_sha512_sha512_ecdsa_brainpoolP512r1ConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class Verifier_register_sha512_sha512_sha512_ecdsa_brainpoolP512r1__factory extends ContractFactory {
  constructor(
    ...args: Verifier_register_sha512_sha512_sha512_ecdsa_brainpoolP512r1ConstructorParams
  ) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  ): Verifier_register_sha512_sha512_sha512_ecdsa_brainpoolP512r1__factory {
    return super.connect(
      runner
    ) as Verifier_register_sha512_sha512_sha512_ecdsa_brainpoolP512r1__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): Verifier_register_sha512_sha512_sha512_ecdsa_brainpoolP512r1Interface {
    return new Interface(
      _abi
    ) as Verifier_register_sha512_sha512_sha512_ecdsa_brainpoolP512r1Interface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as Verifier_register_sha512_sha512_sha512_ecdsa_brainpoolP512r1;
  }
}
