...
import type {
  ...
  Verifier_dsc_sha1_ecdsa_brainpoolP256r1Interface,
} from "../../../../../contracts/verifiers/local/dsc/Verifier_dsc_sha1_ecdsa_brainpoolP256r1";
...
type Verifier_dsc_sha1_ecdsa_brainpoolP256r1ConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: Verifier_dsc_sha1_ecdsa_brainpoolP256r1ConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class Verifier_dsc_sha1_ecdsa_brainpoolP256r1__factory extends ContractFactory {
  constructor(
    ...args: Verifier_dsc_sha1_ecdsa_brainpoolP256r1ConstructorParams
  ) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  ): Verifier_dsc_sha1_ecdsa_brainpoolP256r1__factory {
    return super.connect(
      runner
    ) as Verifier_dsc_sha1_ecdsa_brainpoolP256r1__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): Verifier_dsc_sha1_ecdsa_brainpoolP256r1Interface {
    return new Interface(
      _abi
    ) as Verifier_dsc_sha1_ecdsa_brainpoolP256r1Interface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as Verifier_dsc_sha1_ecdsa_brainpoolP256r1;
  }
}
