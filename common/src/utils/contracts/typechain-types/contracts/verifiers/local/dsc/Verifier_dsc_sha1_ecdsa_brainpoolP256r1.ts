...
export interface Verifier_dsc_sha1_ecdsa_brainpoolP256r1Interface
  extends Interface {
...
export interface Verifier_dsc_sha1_ecdsa_brainpoolP256r1 extends BaseContract {
  connect(
    runner?: ContractRunner | null
  ): Verifier_dsc_sha1_ecdsa_brainpoolP256r1;
  waitForDeployment(): Promise<this>;

  interface: Verifier_dsc_sha1_ecdsa_brainpoolP256r1Interface;
