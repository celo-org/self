...
export interface Verifier_vc_and_discloseInterface extends Interface {
...
export interface Verifier_vc_and_disclose extends BaseContract {
  connect(runner?: ContractRunner | null): Verifier_vc_and_disclose;
  waitForDeployment(): Promise<this>;

  interface: Verifier_vc_and_discloseInterface;
